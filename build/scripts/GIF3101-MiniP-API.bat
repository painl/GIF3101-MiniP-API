...
@rem ##########################################################################
@rem
@rem  GIF3101-MiniP-API startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and GI_F3101_MINI_P_API_OPTS to pass JVM options to this script.
...
:fail
rem Set variable GI_F3101_MINI_P_API_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%GI_F3101_MINI_P_API_EXIT_CONSOLE%" exit 1
exit /b 1
